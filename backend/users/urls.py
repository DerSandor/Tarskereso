...
from .views import RegisterView, LoginView, ChangePasswordView, PasswordResetRequestView, PasswordResetConfirmView, SearchUsersView, GetUserIdView, GetUserView
